...
export default function App() {
  ...
  return (
    <ThemeProvider>
      <CurrencyProvider>
        <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 overflow-x-hidden">
          {/* Floating decorative elements */}
          <div className="fixed inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-1/4 left-1/4 w-32 h-32 sm:w-64 sm:h-64 bg-blue-200/30 dark:bg-blue-800/20 rounded-full blur-3xl float"></div>
            <div className="absolute top-3/4 right-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-indigo-200/20 dark:bg-indigo-800/15 rounded-full blur-3xl float" style={{animationDelay: '1s'}}></div>
          ...
          <main className="relative z-10 w-full max-w-7xl mx-auto p-4 sm:p-6">
            <div className="slide-up fade-in w-full">
              <Routes>
